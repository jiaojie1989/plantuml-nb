...
@MultiViewElement.Registration(
    displayName = "#LBL_puml_VISUAL",
iconBase = "org/netbeans/modules/plantumlnb/icon.png",
mimeType = "text/plain",
persistenceType = TopComponent.PERSISTENCE_NEVER,
preferredID = "pumlVisual",
position = 2000)
@Messages("LBL_puml_VISUAL=Visual")
public final class pumlVisualElement extends JPanel implements MultiViewElement {
